...
ras_cis_data <- read_parquet(paste0(data_dir, "monthly_extract/srasa_smr_extract_2026-01.parquet")) %>%
  subset_smr01_extract(group_to = "cis", filter_by = "ras") %>% # this will be leaving some multiple columns per cis 
